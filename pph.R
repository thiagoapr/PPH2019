...
## Este código calcula um fator de expansao da PPH com base no PNAD 2018
...
# Numero de observacoes da amostra por UF
...
## PNAD Continua 2018 (usar a POF quando estiver disponível)
